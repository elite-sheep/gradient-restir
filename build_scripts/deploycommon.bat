...
rem Copy DLSS
rem set NGXDir=%ExtDir%\ngx
rem if exist %NGXDir% (
rem     robocopy %NGXDir%\lib\Windows_x86_64\rel %OutDir% nvngx_dlss.dll /r:0 >nul
rem )

set DLSSDDir=%ExtDir%\experimental-dlss
if exist %DLSSDDir% (
    robocopy %DLSSDDir%\lib\Windows_x86_64\rel %OutDir% nvngx_dlss.dll /r:0 >nul
)
