...
primal = read_exr(os.path.join("./primal/", "primal.exr"))
primal = gamma_correction(primal, 2.2)
save_png(primal, os.path.join("./primal/", "primal.png"))

dx = read_exr(os.path.join("./dx/", "dx.exr"))
dx = img_remap(dx, -0.02, 0.02, os.path.join("./dx/", "dx.png"))

dy = read_exr(os.path.join("./dy/", "dy.exr"))
dy = img_remap(dy, -0.02, 0.02, os.path.join("./dy/", "dy.png"))

recon = read_exr(os.path.join("./recon/", "recon.exr"))
recon = gamma_correction(recon, 2.2)
save_png(recon, os.path.join("./recon/", "recon.png"))
